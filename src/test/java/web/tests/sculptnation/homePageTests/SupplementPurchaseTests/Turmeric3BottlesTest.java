...
@Story("Supplement Purchase Turmeric Black 3 Bottles Test")
@Listeners( framework.testng.AllureScreenshots.class )
public class Turmeric3BottlesTest extends BaseTest {
    ...
    @Description("Verify Turmeric Black supplement 3 Bottles purchase")
    @Test()//UUID=C81DB584-2D10-422D-97C9-79F7F371F398
    public void purchaseTurmericBlackSupplement3Bottles() throws Exception {
        ...
        RcptPg.verifyReceiptPgTotalsMatch("$554.95");
    }
}